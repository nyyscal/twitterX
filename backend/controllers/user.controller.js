...
export const updateUser = async(req,res) =>{
  ...
  try{
    ...
    if((!newPassword && currentPassword)||(!currentPassword && newPassword)){ 
      return res.status(404).json({messgae:"Please provide both the current password and new password!"})}
    ...
    return res.status(200).json(user)
      ...
      console.log("Error occured in updateUser controller!", err.message)
  }
}